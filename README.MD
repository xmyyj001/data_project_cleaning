...
**Note: this script use dplyr package, using group_by and summarize_all functions. Maybe another way to accomplish the work too. Which is reshape2 package£¬by using melt and dcast functions.
